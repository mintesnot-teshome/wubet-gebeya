...
function Home() {
    return (
        <div>
            <Carousel responsive={responsive} customTransition="1s" transitionDuration={1000}>
            ...
            <div className="homePro">
                ...
                <div className="hc1">
                    <Carousel responsive={responsive1} customTransition="1s" transitionDuration={1000}>
                        {Data[0].map((elem, index) => {
                            return (
                                <Link href={`/products/${elem._id}`} key={index}>
                ...
                <div className="hc1">
                    <Carousel responsive={responsivefeatures} customTransition="1s" transitionDuration={1000}>
